...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // recrypt
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // recrypt
    return genesis;
}
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 985500; // recrypt halving every 4 years
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000036a70ae675b98824c5"); // recrypt
        ...
        vSeeds.push_back(CDNSSeedData("recrypt3.dynu.net", "recrypt3.dynu.net", false)); // Recrypt mainnet
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000d6e528bcf5a3a556f"); // recrypt
        ...
        vSeeds.push_back(CDNSSeedData("recrypt4.dynu.net", "recrypt4.dynu.net", false)); // Recrypt testnet
...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Height = 0; // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests) // activate for recrypt
